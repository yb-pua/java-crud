...
class xiugai extends JFrame {
    ...
    public xiugai(String id ,String name ,String sex,String age ,String xibu,String zhuanye,String zhicheng,String shiyanshi,String zhiwu,String zhengzhi) {
        ...
        lblNewLabel.setFont(new Font("仿宋", Font.ITALIC, 22));
        ...
        lblNewLabel_2.setFont(new Font("仿宋", Font.PLAIN, 22));
        ...
        btnNewButton.setFont(new Font("仿宋", Font.PLAIN, 22));
        ...
        btnNewButton_1.setFont(new Font("仿宋", Font.PLAIN, 22));
